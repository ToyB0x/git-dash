  ...
  return (
      <div>
        <p className="text-gray-500">
          Workspace owners can manage configs.
        </p>

        <section className="flex justify-between mt-8">
          <div>Manage Workspace Name</div>
            <Button disabled={!isMeOwner} className="w-24">Update</Button>
        </section>

          <section className="flex justify-between mt-8">
              <div>Delete Workspace</div>
              <Button variant="destructive" disabled={!isMeOwner} className="w-24">Delete</Button>
          </section>
      </div>
  );
}